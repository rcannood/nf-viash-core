...
meta = [
  ...
  "build_info" : {
    "config" : "/home/rcannood/workspace/viash-io/viash/src/test/resources/test_languages/./python/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native|docker",
    "output" : "/home/rcannood/workspace/viash-io/nf-viash/viash-target/nextflow/test_languages_python",
...
par = {
  ...
  'real_number': $( if [ ! -z ${VIASH_PAR_REAL_NUMBER+x} ]; then echo "float(r'${VIASH_PAR_REAL_NUMBER//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'whole_number': $( if [ ! -z ${VIASH_PAR_WHOLE_NUMBER+x} ]; then echo "int(r'${VIASH_PAR_WHOLE_NUMBER//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'long_number': $( if [ ! -z ${VIASH_PAR_LONG_NUMBER+x} ]; then echo "int(r'${VIASH_PAR_LONG_NUMBER//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  's': $( if [ ! -z ${VIASH_PAR_S+x} ]; then echo "r'${VIASH_PAR_S//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'truth': $( if [ ! -z ${VIASH_PAR_TRUTH+x} ]; then echo "r'${VIASH_PAR_TRUTH//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'falsehood': $( if [ ! -z ${VIASH_PAR_FALSEHOOD+x} ]; then echo "r'${VIASH_PAR_FALSEHOOD//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'reality': $( if [ ! -z ${VIASH_PAR_REALITY+x} ]; then echo "r'${VIASH_PAR_REALITY//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'log': $( if [ ! -z ${VIASH_PAR_LOG+x} ]; then echo "r'${VIASH_PAR_LOG//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'optional': $( if [ ! -z ${VIASH_PAR_OPTIONAL+x} ]; then echo "r'${VIASH_PAR_OPTIONAL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'optional_with_default': $( if [ ! -z ${VIASH_PAR_OPTIONAL_WITH_DEFAULT+x} ]; then echo "r'${VIASH_PAR_OPTIONAL_WITH_DEFAULT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'multiple': $( if [ ! -z ${VIASH_PAR_MULTIPLE+x} ]; then echo "r'${VIASH_PAR_MULTIPLE//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'multiple_pos': $( if [ ! -z ${VIASH_PAR_MULTIPLE_POS+x} ]; then echo "r'${VIASH_PAR_MULTIPLE_POS//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi )
}
meta = {
