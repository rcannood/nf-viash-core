...
meta = [
  ...
  "build_info" : {
    "config" : "/home/rcannood/workspace/viash-io/viash/src/test/resources/test_languages/./scala/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native|docker",
    "output" : "/home/rcannood/workspace/viash-io/nf-viash/viash-target/nextflow/test_languages_scala",
...
case class ViashPar(
  ...
  real_number: Double,
  whole_number: Int,
  long_number: Option[Long],
  s: String,
  truth: Boolean,
  falsehood: Boolean,
  reality: Option[Boolean],
  output: Option[String],
  log: Option[String],
  optional: Option[String],
  optional_with_default: Option[String],
  multiple: List[String],
  multiple_pos: List[String]
)
val par = ViashPar(
  """${VIASH_PAR_INPUT//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""",
  """${VIASH_PAR_REAL_NUMBER//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""".toDouble,
  """${VIASH_PAR_WHOLE_NUMBER//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""".toInt,
  $( if [ ! -z ${VIASH_PAR_LONG_NUMBER+x} ]; then echo "Some("'"""'"${VIASH_PAR_LONG_NUMBER//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  """${VIASH_PAR_S//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""",
  """${VIASH_PAR_TRUTH//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""".toLowerCase.toBoolean,
  """${VIASH_PAR_FALSEHOOD//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""".toLowerCase.toBoolean,
  $( if [ ! -z ${VIASH_PAR_REALITY+x} ]; then echo "Some("'"""'"${VIASH_PAR_REALITY//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLowerCase.toBoolean)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "Some("'"""'"${VIASH_PAR_OUTPUT//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'")"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_PAR_LOG+x} ]; then echo "Some("'"""'"${VIASH_PAR_LOG//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'")"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_PAR_OPTIONAL+x} ]; then echo "Some("'"""'"${VIASH_PAR_OPTIONAL//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'")"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_PAR_OPTIONAL_WITH_DEFAULT+x} ]; then echo "Some("'"""'"${VIASH_PAR_OPTIONAL_WITH_DEFAULT//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'")"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_PAR_MULTIPLE+x} ]; then echo ""'"""'"${VIASH_PAR_MULTIPLE//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".split("'"""'";"'"""'").toList"; else echo "Nil"; fi ),
  $( if [ ! -z ${VIASH_PAR_MULTIPLE_POS+x} ]; then echo ""'"""'"${VIASH_PAR_MULTIPLE_POS//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".split("'"""'";"'"""'").toList"; else echo "Nil"; fi )
)
case class ViashMeta(
  ...
  memory_kib: Option[Long],
  memory_mib: Option[Long],
  memory_gib: Option[Long],
  memory_tib: Option[Long],
  memory_pib: Option[Long]
)
val meta = ViashMeta(
  """${VIASH_META_NAME//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""",
  ...
  """${VIASH_META_CONFIG//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""",
  """${VIASH_META_TEMP_DIR//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}""",
  $( if [ ! -z ${VIASH_META_CPUS+x} ]; then echo "Some("'"""'"${VIASH_META_CPUS//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toInt)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_B+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_B//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_KB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_KB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_MB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_MB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_GB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_GB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_TB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_TB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_PB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_PB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_KIB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_KIB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_MIB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_MIB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_GIB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_GIB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_TIB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_TIB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi ),
  $( if [ ! -z ${VIASH_META_MEMORY_PIB+x} ]; then echo "Some("'"""'"${VIASH_META_MEMORY_PIB//\\"/\\"\\"\\"+\\"\\\\\\"\\"+\\"\\"\\"}"'"""'".toLong)"; else echo "None"; fi )
)
case class ViashDep(
