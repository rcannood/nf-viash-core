...
meta = [
  ...
  "build_info" : {
    "config" : "/home/rcannood/workspace/viash-io/viash/src/test/resources/test_languages/./js/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native|docker",
    "output" : "/home/rcannood/workspace/viash-io/nf-viash/viash-target/nextflow/test_languages_js",
...
let par = {
  ...
  'real_number': $( if [ ! -z ${VIASH_PAR_REAL_NUMBER+x} ]; then echo "parseFloat(String.raw\\`${VIASH_PAR_REAL_NUMBER//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'whole_number': $( if [ ! -z ${VIASH_PAR_WHOLE_NUMBER+x} ]; then echo "parseInt(String.raw\\`${VIASH_PAR_WHOLE_NUMBER//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'long_number': $( if [ ! -z ${VIASH_PAR_LONG_NUMBER+x} ]; then echo "parseInt(String.raw\\`${VIASH_PAR_LONG_NUMBER//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  's': $( if [ ! -z ${VIASH_PAR_S+x} ]; then echo "String.raw\\`${VIASH_PAR_S//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  'truth': $( if [ ! -z ${VIASH_PAR_TRUTH+x} ]; then echo "String.raw\\`${VIASH_PAR_TRUTH//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`.toLowerCase() === 'true'"; else echo undefined; fi ),
  'falsehood': $( if [ ! -z ${VIASH_PAR_FALSEHOOD+x} ]; then echo "String.raw\\`${VIASH_PAR_FALSEHOOD//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`.toLowerCase() === 'true'"; else echo undefined; fi ),
  'reality': $( if [ ! -z ${VIASH_PAR_REALITY+x} ]; then echo "String.raw\\`${VIASH_PAR_REALITY//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`.toLowerCase() === 'true'"; else echo undefined; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "String.raw\\`${VIASH_PAR_OUTPUT//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  'log': $( if [ ! -z ${VIASH_PAR_LOG+x} ]; then echo "String.raw\\`${VIASH_PAR_LOG//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  'optional': $( if [ ! -z ${VIASH_PAR_OPTIONAL+x} ]; then echo "String.raw\\`${VIASH_PAR_OPTIONAL//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  'optional_with_default': $( if [ ! -z ${VIASH_PAR_OPTIONAL_WITH_DEFAULT+x} ]; then echo "String.raw\\`${VIASH_PAR_OPTIONAL_WITH_DEFAULT//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  'multiple': $( if [ ! -z ${VIASH_PAR_MULTIPLE+x} ]; then echo "String.raw\\`${VIASH_PAR_MULTIPLE//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`.split(';')"; else echo undefined; fi ),
  'multiple_pos': $( if [ ! -z ${VIASH_PAR_MULTIPLE_POS+x} ]; then echo "String.raw\\`${VIASH_PAR_MULTIPLE_POS//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`.split(';')"; else echo undefined; fi )
};
let meta = {
  'name': $( if [ ! -z ${VIASH_META_NAME+x} ]; then echo "String.raw\\`${VIASH_META_NAME//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`"; else echo undefined; fi ),
  ...
  'memory_kib': $( if [ ! -z ${VIASH_META_MEMORY_KIB+x} ]; then echo "parseInt(String.raw\\`${VIASH_META_MEMORY_KIB//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'memory_mib': $( if [ ! -z ${VIASH_META_MEMORY_MIB+x} ]; then echo "parseInt(String.raw\\`${VIASH_META_MEMORY_MIB//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'memory_gib': $( if [ ! -z ${VIASH_META_MEMORY_GIB+x} ]; then echo "parseInt(String.raw\\`${VIASH_META_MEMORY_GIB//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'memory_tib': $( if [ ! -z ${VIASH_META_MEMORY_TIB+x} ]; then echo "parseInt(String.raw\\`${VIASH_META_MEMORY_TIB//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi ),
  'memory_pib': $( if [ ! -z ${VIASH_META_MEMORY_PIB+x} ]; then echo "parseInt(String.raw\\`${VIASH_META_MEMORY_PIB//\\`/\\`+\\"\\`\\"+String.raw\\`}\\`)"; else echo undefined; fi )
};
let dep = {
